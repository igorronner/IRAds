...
class MainApp : Application() {
    ...
    override fun onCreate() {
        ...
        IRAdsInit.start()
                ...
                .setMidInterstitialId("ca-app-pub-3940256099942544/1033173712")
                .setExpensiveInterstitialId("ca-app-")
                .setNativeAdId("ca-app-pub-3940256099942544/2247696110")
                .setTwoFloorNativeAd("ca-app-pub-3940256099942544/2247696110",
